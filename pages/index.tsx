...
const exploreArticles = () => (
  <div className='bg-dark-primary'>
    ...
    <section className='px-32 py-2'>
      ...
      <div className='grid grid-rows-2 grid-flow-col w-3/5 gap-4 text-white'>
        <img src={expLogo} className='row-span-2 mt-4' width='100%' alt='expLogo' />
        <div className='row-span-1 col-span-1 font-inter text-5xl font-bold'>Explore Articles</div>
        <div className='row-span-1 col-span-4 mb-4'>With a wide range of selection hover over here and there</div>
      </div>
    ...
    */}
    ...
    <section className='z-5'>
      <div className='inline-block text-white mt-20 w-full whitespace-no-wrap overflow-x-scroll font-semibold text-5xl'>
